...
//                            var_dump($update_subscriber);
            ...
            */
            ...
            function addAdminMenus() {
                ...
                $this->page_hooks['im-ar-list'] = add_submenu_page('im-ar-settings', __('List'), __('List'), 'manage_options', 'im-ar-list', array($this, 'pageList'));                    
                ...
                add_action("load-{$this->page_hooks['im-ar-list']}", array($this, 'handlerLoadPageList'));
            ...
            */
            ...
            /**
            * Handle loading list page.
            */
            
            function handlerLoadPageList() {
                wp_enqueue_script('im-ar-list', IM_AR_PLUGIN_URL.'/scripts/list.js', array('jquery'));
                wp_localize_script('im-ar-list', 'im_ar_cfg', array(
                    'ajax_url' => admin_url('admin-ajax.php'),
                    'list_id' => $this->options->values['list']['id'],
                    'settings_link' => admin_url('admin.php?page=im-ar-settings')
                ));
            }
            ...
            */
            ...
            function pageList() {
                ...
                ImnicaMailAutoRegisterFunctions::loadView('page-list', array('im_ar' => $this));
            }
            ...
            */
            ...
            function ajaxUserLogin() {
                ...
                if (is_object($response) && $response->Success) {
                    $page_list_url = admin_url('admin.php?page=im-ar-list');
                    $response->SuccessText = array(
                        "Login successfully validated. Click <a href=\"{$page_list_url}\">here</a> to set the receiving list."
                    );
                }
            ...
            */
            ...
            function ajaxSaveList() {
                ...
                $page_field_mapping_url = admin_url('admin.php?page=im-ar-field-mapping');
                 
                die(json_encode(array(
                    'Success' => true,
                    'SuccessText' => array(
                        "List successfull saved. Click <a href=\"{$page_field_mapping_url}\">here</a> to configure the field mapping."
                    )
                )));     
            }                      
